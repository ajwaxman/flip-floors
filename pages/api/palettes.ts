...
const fetchGenesisPaletteFloor = async (name) => {
    let url = "https://indexer-v31-mainnet.up.railway.app/tokens?collection=flipmap&sortBy=floorSellValue&sortDirection=asc&offset=0&limit=5&attributes%5BPalette%5D=Genesis%20(%230)"
...
const fetchFlipFloor = async (name) => {
    let url = "https://indexer-v31-mainnet.up.railway.app/tokens?collection=flipmap&sortBy=floorSellValue&sortDirection=asc&offset=0&limit=6&attributes%5BPalette%5D="
