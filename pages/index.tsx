...
const FlipFloor = ({ flips, compositions, lastUpdate }: Props) => {
    return (
        <div className="py-3 md:pb-0 font-mono tracking-tighter flex flex-col justify-center items-center gap-4 pt-10 md:w-screen">
            <div className="absolute top-3 right-3 text-gray-400" style={{fontSize: "13px"}}>
            ...
            <h1 className="text-lg mt-4 text-gray-100 md:text-2xl font-bold"><span className="pr-1">🖼</span> Flipmap Composition Floor Rankings</h1>
            <div className="text-gray-100 text-center max-w-screen-md md:leading-loose">
                ...
                {/* <p className="text-orange-500 text-xs mv-4 mb-2 mt-4"> 🚧 The data is not updating properly. This is being actively looked into. Thank you for your patience. 🚧</p> */}
            </div>
